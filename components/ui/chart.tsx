...
// Theme configuration for CSS injection
...
function ChartLegendContent(props: RechartsPrimitive.LegendProps & React.ComponentProps<"div"> & { hideIcon?: boolean; nameKey?: string }) {
